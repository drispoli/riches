...
import com.fortify.samples.riches.model.Role;
...
public class ConnectionFactory
{
	...
	private ConnectionFactory()
	{
		...
		try
		{
			 ...
			 * 
			 */
			Configuration cfg = new Configuration().addClass(Account.class).addClass(Transaction.class).addClass(Message.class).addClass(Profile.class).addClass(Role.class);
